...
namespace Xin.AQS
{
    ...
    /// 空气质量指数日报
    /// </summary>
    public class DayAQIResult : AQIResult
    {
        /// <summary>
        ...
        /// <summary>
        /// 颗粒物（粒径小于等于10μm）24小时平均浓度空气质量分指数
        /// </summary>
        ...
        /// <summary>
        /// 臭氧（O3）最大8小时滑动平均浓度空气质量分指数
        /// </summary>
        public int? IO38H { get; set; }
        /// <summary>
        /// 颗粒物（粒径小于等于2.5μm）24小时平均浓度（μg/m³）
        /// </summary>
        public decimal? PM25 { get; set; }
        /// <summary>
        /// 颗粒物（粒径小于等于2.5μm）24小时平均浓度空气质量分指数
        /// </summary>
        ...
        {
            AQICalculate.CalculateDayAQI(this);
        }
    }
}
